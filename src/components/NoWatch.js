...
import favExample from '../images/watch-example.png';
...
const NoWatch =() => {
    ...
    return(
        ...
        <section className='nofavs'>
            ...
            <h2>Oh no!</h2>
            <h3>You haven't added any movies to your Watch Later list!</h3>
            <p>Please return to the home page and add a movie by clicking on the plus icon.</p>
            </div>
